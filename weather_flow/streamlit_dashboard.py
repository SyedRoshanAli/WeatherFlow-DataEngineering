...
# WeatherAPI key from project configuration
WEATHER_API_KEY = "1f5800c837ab40bfbe2161243251305"
...
def add_city():
    ...
    try:
        ...
        weather_api_url = f"http://api.weatherapi.com/v1/current.json?key={WEATHER_API_KEY}&q={city},{country}&aqi=no"
